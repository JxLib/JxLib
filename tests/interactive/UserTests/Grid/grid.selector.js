{
    tests: [
        {
            title: "Grid - selector plugin - cell selection",
            description: "This test is to verify that selector plugin works. Only the clicked cell should select.",
            ...
            title: "Grid - selector plugin - row selection",
            description: "This test is to verify that selector plugin works. The entire clicked row should select",
            ...
            title: "Grid - selector plugin - column selection",
            description: "This test is to verify that selector plugin works. The entire clicked column should select",
            ...
            title: "Grid - selector plugin - column selection, no headers",
            description: "This test is to verify that selector plugin works. Only the clicked cell should select.",
            verify: "When you click a column does it select?",
            before: function(){
            ...
            title: "Grid - selector plugin - row selection, no headers",
            description: "This test is to verify that selector plugin works. The entire clicked row should select",
            verify: "When you click a row does it select?",
            before: function(){
    ...
    otherScripts: ["currency","date","boolean","phone","grid.selector",'parser.json','strategy.full','record','protocol.local','response']
}
